...
class Book:
    def __init__(self, library: Library, publication_date, author_name: str,
                 author_surname: str, number_of_pages):
...
class Order:
    ...
    def __str__(self):
        return (f'Book {self.books} shipped by {self.employee} '
                f'to {self.student}')
